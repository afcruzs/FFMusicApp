...
public class FfMusicApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class RoomEndPoint {
    ...
    /**
     * Create a request for the method "roomEndPoint.vote".
     *
     * This request holds the parameters needed by the ffMusicApi server.  After setting any optional
     ...
     * @return the request
     */
    public Vote vote(com.ffmusic.backend.ffMusicApi.model.SongRoom content) throws java.io.IOException {
      Vote result = new Vote(content);
      initialize(result);
      return result;
    }

    public class Vote extends FfMusicApiRequest<com.ffmusic.backend.ffMusicApi.model.SongRoom> {

      private static final String REST_PATH = "vote";
       ...
       * @since 1.13
       */
      protected Vote(com.ffmusic.backend.ffMusicApi.model.SongRoom content) {
        super(FfMusicApi.this, "POST", REST_PATH, content, com.ffmusic.backend.ffMusicApi.model.SongRoom.class);
      }

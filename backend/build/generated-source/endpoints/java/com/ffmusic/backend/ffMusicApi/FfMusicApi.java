...
public class FfMusicApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class RoomEndPoint {
     ...
     * @return the request
     */
    public Songs songs(com.ffmusic.backend.ffMusicApi.model.Room content) throws java.io.IOException {
      Songs result = new Songs(content);
      initialize(result);
      return result;
    }
    ...
    public class Songs extends FfMusicApiRequest<com.ffmusic.backend.ffMusicApi.model.SongRoomCollection> {
      ...
      private static final String REST_PATH = "songs";
       ...
       * @since 1.13
       */
      protected Songs(com.ffmusic.backend.ffMusicApi.model.Room content) {
        super(FfMusicApi.this, "POST", REST_PATH, content, com.ffmusic.backend.ffMusicApi.model.SongRoomCollection.class);
      }
